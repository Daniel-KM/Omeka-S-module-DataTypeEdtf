...
class DateInInterval implements FacetTypeInterface
{
    ...
    {
        $view->headScript()->appendFile($view->assetUrl('js/faceted-browse/facet-data-form/date-in-interval.js', 'DataTypeEdtf'));
    }
    ...
    {
        $view->headScript()->appendFile($view->assetUrl('js/faceted-browse/facet-render/date-in-interval.js', 'DataTypeEdtf'));
    }
    ...
    public function renderFacet(PhpRenderer $view, FacetedBrowseFacetRepresentation $facet): string
    {
        ...
        $elementValues->setName('edtf_in_interval');
